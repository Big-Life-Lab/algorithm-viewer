...
#' current browser URL via \code{url_update_query_string()}. Does not trigger a
#' full page reload.
#'
...
#'
#' A thin wrapper around \code{shiny::updateQueryString()} that updates the
#' current URL in the browser without triggering a full page reload.
#'
...
#'   domain via \code{shiny::getDefaultReactiveDomain()}.
#' @return Called for its side-effect; returns `NULL` invisibly.
#'
#' @noRd
#' @keywords internal
