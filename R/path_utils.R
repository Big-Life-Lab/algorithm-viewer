...
#'
#' This is generally for informational purposes to report to the user, rather
#' than for retrieving paths used for disk access. It is meant to hide the
#' full paths of files on the system from a user so that attackers cannot
#' gather information about the system's directory structure. Usually, the
#' relative_to_path parameter would be the sandbox path.
#'
